...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_Qi4d.pack(_x.field, _x.index, _x.value.x, _x.value.y, _x.value.z, _x.value.w))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.field, _x.index, _x.value.x, _x.value.y, _x.value.z, _x.value.w,) = _struct_Qi4d.unpack(str[start:end])
      return self
