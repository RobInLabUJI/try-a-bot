...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_Qi4f.pack(_x.field, _x.index, _x.value.r, _x.value.g, _x.value.b, _x.value.a))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.field, _x.index, _x.value.r, _x.value.g, _x.value.b, _x.value.a,) = _struct_Qi4f.unpack(str[start:end])
      return self
