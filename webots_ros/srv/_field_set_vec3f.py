...
float64 z"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_Qi3d.pack(_x.field, _x.index, _x.value.x, _x.value.y, _x.value.z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.field, _x.index, _x.value.x, _x.value.y, _x.value.z,) = _struct_Qi3d.unpack(str[start:end])
      return self
